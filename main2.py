...
df = df_man.find_records_within_period(df, conf_json["date_key"], "2021-04-19", '2021-04-23')
...
df = df_man.change_date_type_to_str(df, conf_json["date_key"])

# TODO グルーピング機能を実装
results = df_man.get_column_values(df)
